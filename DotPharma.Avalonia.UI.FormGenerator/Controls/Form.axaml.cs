...
public class Form : ItemsControl
{
    ...
    public static readonly StyledProperty<LabelPosition> LabelPositionProperty = AvaloniaProperty.Register<Form, LabelPosition>(
        nameof(LabelPosition), defaultValue: Common.LabelPosition.Top);
