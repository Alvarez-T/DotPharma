...
namespace DotPharma.Avalonia.UI.FormGenerator.Controls;
...
public class FormItem : ContentControl
{
    ...
    private readonly List<IDisposable> _formSubscriptions = new List<IDisposable>();
    ...
    static FormItem()
    {
        NoLabelProperty.Changed.AddClassHandler<FormItem, bool>((fItem, e) =>
        {
            PseudolassesExtensions.Set(fItem.Classes, PC_NoLabel, e.NewValue.Value);
        });
    }
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        if (form is not null)
        {
            ...
            var positionSubscription = form
                ...
                .Subscribe(new AnonymousObserver<LabelPosition>(position => { PseudoClasses.Set(PC_Horizontal, position == LabelPosition.Left); }));
